...
end Range_Sensor_Second;

architecture Behavioral of Range_Sensor_Second is
...
begin
    ...
    Pulsewidth_Second : Distance_Calculation port map (fpgaclk, triggOut, pulse, distanceOut);
    BCDConv_Second : BCD_Converter port map (distanceOut, meters, decimeters, centimeters);
